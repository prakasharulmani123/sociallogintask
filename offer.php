...
$Configuration = array(
    ...
    // old code start here
    // Yahoo details
    "yahoo_consumer_key" => 'dj0yJmk9eW05ZW1kUU0xU3FCJmQ9WVdrOVJtNDBOVVZPTnpZbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD02OA--',
    "yahoo_consumer_secret" => '5598df2de9b76e4f85f04f2f2c2b0ec5df3889f4',
    "yahoo_callback_url" => $base_url . 'offer.php?type=yahoo',
    // #Twitter details
    ...
    "twitter_follow_user_name" => $twitter_follow_user_name,
    //  #Instagram details
    "instagram_app_key" => '4cb67c42fe274b5dbbf6fb6f84a3c19d',
    "instagram_app_secret" => '5400eb4a448c42e69b7fa8f21a88521c',
    "instagram_app_callback_url" => $base_url . 'offer.php?type=instagram',
    "instagram_follow_user_id" => $instagram_follow_user_id,
    #Linkedin
    "linkedin_api_key" => "77ucddnjfet1je",
    "linkedin_api_secret" => "tEoZeHLyJpXJAHxO",
    "linkedin_callback_url" => $base_url . "offer.php?type=linkedin",
    # Youtube details
    ...
    "google_youtube_channel_id" => $youtube, // Youtube for developer
    "google_youtube_redirect_uri" => $base_url . "offer.php?type=youtube",
    #Facebook details
    ...
    "googleplus_redirect_uri" => $base_url . "offer.php?type=googleplus",
    // old code end here
    #Campaign Monitor details
    "campaignmonitor_client_id" => "5614fd8006aef1e3fad7bd75c795ba5a",
    "campaignmonitor_client_secret" => "9ff5f5ad8f357e44bc51807060901971",
    "campaignmonitor_redirect_uri" => $base_url . "offer.php?type=campaignmonitor",
    ...
    "getresponse_redirect_uri" => $base_url . "offer.php?type=getresponse",
    ...
    "constantcontact_redirect_uri" => $base_url . "offer.php?type=constantcontact",
    #Mailchimp details
    ...
    "mailchimp_redirect_uri" => $base_url . "offer.php?type=mailchimp",
    "mailchimp_access_token" => "a43701290a5b0737fb751a2d4f647e77",
    #Microsoft details
    ...
    "google_redirect_uri" => $base_url . "offer.php?type=google",
);
    ...
    if ($_GET['type'] == 'constantcontact') {
        ...
        if (!isset($_COOKIE['ctct'])) {
            ...
            if ($_COOKIE['ctct'] >= 1) {
                ...
                if (!isset($_COOKIE['ctct'])) {
                    header("Location: offer.php?type=constantcontact");
                }
            }
        }
        // setcookie("ctct","1");
...
if (isset($_POST['get_content'])) {
    ...
    header("Location: offer.php?msg=success");
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                    <a href="dashboard.php" class="btn btn-default btn-lg btn-flat"><i class="fa fa-facebook"></i> Login with facebook!</a>
                ...
                <div class="box box-default">
                   ...
                   <?php } elseif (@$page == 'phone_verified') { ?>
                        <div class="action_block bad_email">
                                ...
                                <form method="POST">
                                    <p><input type="hidden" name="phone" value="<?php echo (isset($phone) && $phone != '') ? $phone : ''; ?>" /></p>
...
<!-- Row 1 -->
        ...
        <!-- Col 1 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=facebook')"><div class="col-md-3">
        ...
        <!-- Col 2 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=googleplus')"><div class="col-md-3">
        ...
        <!-- Col 3 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=linkedin')"><div class="col-md-3">
        ...
        <!-- Col 4 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=twitter')"><div class="col-md-3">
...
<!-- Row 2 -->
        ...
        <!-- Col 1 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=youtube')"><div class="col-md-3">
        ...
        <!-- Col 3 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=google')"><div class="col-md-3">
        ...
        <!-- Col 4 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=microsoft')"><div class="col-md-3">
...
<!-- Row 3 -->
        ...
        <!-- Col 1 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=yahoo')"><div class="col-md-3">
        ...
        <!-- Col 2 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=mailchimp')"><div class="col-md-3">
        ...
        <!-- Col 3 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=constantcontact')"><div class="col-md-3">
        ...
        <!-- Col 4 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=campaignmonitor')"><div class="col-md-3">
...
<!-- Row 4 -->
        ...
        <!-- Col 1 -->  
        <a style="cursor:pointer;" onClick="popuplogin('offer.php?type=getresponse')"><div class="col-md-3">
...
<!--******************** SHARE BUTTONS ********************--->
      ...
      <div class="row">
        <div class="col-xs-4">
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-facebook"><i class="fa fa-facebook fa-2x"></i> Facebook</a></p>
			  <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-pinterest"><i class="fa fa-pinterest fa-2x"></i> Pinterest</a></p>			 			  
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-instagram"><i class="fa fa-vk fa-2x"></i> VK</a></p>		
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-blogger"><i class="fa fa-rss fa-2x"></i> Blogger</a></p>
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-livejournal"><i class="fa fa-pencil fa-2x"></i> LiveJournal</a></p>
			  
        </div>		

        <div class="col-xs-4">
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-google"><i class="fa fa-google-plus fa-2x"></i> Google+</a></p>		
			  <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-linkedin"><i class="fa fa-linkedin fa-2x"></i> Linkedin</a></p>		
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-stumbleupon"><i class="fa fa-stumbleupon fa-2x"></i> Stumbleupon</a></p>	
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-xing"><i class="fa fa-xing fa-2x"></i> Xing</a></p>
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-whatsapp"><i class="fa fa-whatsapp fa-2x"></i> WhatsApp</a></p>			  
				
			  
        </div>		
		
        <div class="col-xs-4">	
              <p><a href="<?php echo $shareurl; ?><?php echo $current_url.'?id'.$value['id'].'='.$myip_add; ?>" target="_blank" class="btn btn-block btn-lg btn-social btn-twitter"><i class="fa fa-twitter fa-2x"></i> Twitter</a></p>		  
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-reddit"><i class="fa fa-reddit fa-2x"></i> Reddit</a></p>				  
			  <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-tumblr"><i class="fa fa-tumblr fa-2x"></i> Tumblr</a></p>
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-flipboard"><i class="fa fa-clipboard fa-2x"></i> Flipboard</a></p>			  
              <!--<p><a href="#" target="_blank" class="btn btn-block btn-social btn-digg"><i class="fa fa-digg fa-2x"></i> Digg</a></p>-->			  
              <p><a href="#" target="_blank" class="btn btn-block btn-lg btn-social btn-telegram"><i class="fa fa-telegram fa-2x"></i> Telegram</a></p>			  
...
//            window.opener.location.replace('offer.php?msg=success');
//            window.close();
